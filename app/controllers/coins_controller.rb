class CoinsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @coin.save
        format.html { redirect_to coin_url(@coin), notice: "Moeda foi criada com sucesso." }
  ...
  def update
    respond_to do |format|
      if @coin.update(coin_params)
        format.html { redirect_to coin_url(@coin), notice: "Moeda foi atualizada com sucesso." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to coins_url, notice: "Moeda foi destruida com sucesso." }
